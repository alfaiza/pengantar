...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Surat Pengantar Laporan</title>
        ...
        <style>
            ...
            body{
                ...
                background-image: url("../../dist/img/bg1.jpeg")
                margin:0
            }
            a{
            ...
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        ...
                        <a href="{{ route('registrasi') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Register</a>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ url('/laporan/show') }}" class="underline text-gray-900 dark:text-white">Input Laporan</a></div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ url('/laporan/show') }}" class="underline text-gray-900 dark:text-white">Lihat Daftar Laporan</a></div>
                            </div>
